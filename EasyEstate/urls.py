...
from common.forms import PasswordSetFormWithPlaceholder, AuthenticationFormWithPlaceholder
...
urlpatterns = [
    ...
    url(r'^accounts/', include(('registration.backends.default.urls', 'django_registration'), namespace='accounts')),
    # url(r'^account/login/$', auth_views.LoginView, {'authentication_form': AuthenticationFormWithPlaceholder}, name='login'),
    url(r'^account/logout/$', auth_views.LogoutView, {'next_page': reverse_lazy('index')}, name='logout'),
    ...
    url(r'^account/reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', auth_views.PasswordResetConfirmView, {'set_password_form': PasswordSetFormWithPlaceholder}, name='password_reset_confirm'),
    url(r'^account/reset/done/$', auth_views.PasswordResetCompleteView, name='password_reset_complete'),
    # url(r'^', include(blog_urls)),
    # url(r'^blog/', include('zinnia.urls')),
    url(r'^comments/', include('django_comments.urls')),
    url(r'^agents/', include(('Agents.urls', 'Agents'), namespace='agents')),
    #url(r'^blog/', include('Blog.urls', namespace='blog')),
    url(r'^message/', include(('message.urls', 'message'), namespace='message')),
    url(r'^controlpanel/', include(('ControlPanel.urls', 'COntrolPanel'), namespace='control')),
    url(r'^customers/', include(('Customers.urls', 'Customer'), namespace='customers')),
    url(r'^faq/', include(('FAQ.urls', 'FAQ'), namespace='faq')),
    url(r'^order/', include(('Order.urls', 'Order'), namespace='order')),
    url(r'^payments/', include(('Payments.urls', 'Payments'), namespace='payments')),
    url(r'^promotion/', include(('Promotion.urls', 'Promotion'), namespace='promotion')),
    url(r'^service/', include(('Services.urls', 'Services'), namespace='service')),
    url(r'^socialmedia/', include(('SocialMedia.urls', 'SocialMedia'), namespace='social')),
